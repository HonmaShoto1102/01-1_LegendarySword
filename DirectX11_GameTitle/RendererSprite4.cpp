...
ID3D11Buffer*CRendererSprite4::m_VertexBuffer = NULL;

void CRendererSprite4::Load()
{

}

void CRendererSprite4::Unload()
{
	//ポインタの解放
	m_VertexBuffer->Release();
}

void CRendererSprite4::Init()
{
	VERTEX_3D vertex[4];
	...
	CRenderer::CreatePixelShader(
		&m_PixelShader,
		"NoisePS.cso");//NoisePS,waterEffectPS
...
void CRendererSprite4::Draw()
{
	...
	//テクスチャ設定
	auto* m_TextureRenderTargetView = CRenderer::GetShaderResourceView4();
...
void CRendererSprite4::SetSize(float width, float height)
{
	m_width = width;
	m_height = height;
}

void CRendererSprite4::SetVolume(bool volume_on_flag)
{
